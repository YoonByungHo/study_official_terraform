...
#     command = <<EOT
# "touch ${path.root}/private_ip.txt"
# "echo 'The servers IP address is ${self.private_ip}' >> ${path.root}/private_ip.txt"
#     EOT
#   }
#     provisioner "file" {
#     source      = "${path.root}/private_ip.txt"
#     destination = "${path.root}/private_ip.txt"
