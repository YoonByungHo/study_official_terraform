...
resource "aws_instance" "example" {
  ...
  provisioner "local-exec" {
    ...
    command = <<EOT
"touch /home/ssm-user/private_ip.txt"
"echo 'The servers IP address is ${self.private_ip}' >> /home/ssm-user/private_ip.txt"
    EOT
  }
    provisioner "file" {
    source      = "/home/ssm-user/private_ip.txt"
    destination = "/home/ssm-user/private_ip.txt"
